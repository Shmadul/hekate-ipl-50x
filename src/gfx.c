...
static const u8 _gfx_font[] = {
	...
	0x00, 0x44, 0x4C, 0x5C, 0x74, 0x64, 0x44, 0x00, 0x00, 0x00, 0x00, 0x82, 0xEE, 0x10, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0xEE, 0x82, 0x00, 0x00,
};
...
void gfx_debug(gfx_con_t *con, gfx_debug_type type, const char *fmt, ...) {
	...
	switch (type) {
		case error:
			gfx_printf(con, "[%k  Error  %k] ", 0xFF0000FF, 0xFFFFFFFF);
			break;

		case warning:
			gfx_printf(con, "[%k Warning %k] ", 0xFF00FFFF, 0xFFFFFFFF);
			break;

		case ok:
			gfx_printf(con, "[%k   Ok    %k] ", 0xFF00FF00, 0xFFFFFFFF);
			break;
